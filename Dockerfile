...
#ENV JBOSS_HOME /opt/jboss/wildfly-25.0.1.Final
...
RUN rmdir /opt/jboss/wildfly-25.0.1.Final/standalone/tmp/auth && \
    mkdir -p /opt/jboss/wildfly-25.0.1.Final/standalone/tmp/auth && \
    chmod 775 /opt/jboss/wildfly-25.0.1.Final/standalone/tmp/auth
...
CMD ["/opt/jboss/wildfly-25.0.1.Final/bin/standalone.sh", "-c", "standalone.xml", "-b", "0.0.0.0", "-bmanagement", "0.0.0.0"]
